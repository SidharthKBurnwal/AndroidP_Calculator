package com.example.android.fullcalculator;
...
public class Calculator extends Activity implements View.OnClickListener {
    ...
    //to arrange the number while tapping alongside
    private void numberIsTapped(int tappedNumber){
        currentNumber = currentNumber + String.valueOf(tappedNumber);
        long rangeOfNum = Integer.valueOf(currentNumber);

        if (rangeOfNum >= 999999) {
            txtCalculations.setText("enter a value smaller then 999999999");
            clearTapped();
        } else {
